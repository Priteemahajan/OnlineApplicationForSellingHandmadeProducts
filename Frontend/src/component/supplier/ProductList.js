                    ...
                    <tbody>
                        ...
                        product =>
                                    <tr key={product.productId}>
                                        ...
                                        <td>
                                            <button className="btn btn-danger" onClick={() => this.deleteProduct(product.productId)}> Delete</button>
                                            <button className="btn btn-success" onClick={() => {this.editProduct(product.productId); this.props.history.push("/supplier/edit_product")}} style={{marginLeft: '20px'}}> Update</button>
                                        </td>
                                    </tr>
                            )
                        }
